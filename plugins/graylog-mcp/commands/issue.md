...
Report an issue with a Graylog MCP tool. Invoke the `mcp-issue` skill to guide the user through documenting the problem. The server is **Graylog** — pass this context to the skill so it skips server identification.
