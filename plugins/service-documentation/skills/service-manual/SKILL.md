...
<footer class="manual-version">
  ...
  <p>Generated by /service-manual skill v2.6.0</p>
</footer>
```
...
- 2.6.0 (2026-02-27) gfrankgva — Catalog-backed dropdown options: fetch classification data for select/radio components, show actual choices in manual
